...
export const GitHubContributions = () => {
  ...
  const [recentContributions, setRecentContributions] = useState<{ type: string; count: number; date: string }[]>([]);
  const [contributionStreak, setContributionStreak] = useState({ current: 0, longest: 0 });
  ...
  useEffect(() => {
    const fetchGitHubData = async () => {
      try {
        ...
        setContributionStreak({ current: currentStreak, longest: longestStreak });
  ...
  return (
    <section id="github" className="py-20 px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto">
      <motion.div
      ...
      >
        <div>
          <h2 className="text-4xl font-bold text-gray-900 mb-2">GitHub Activity</h2>
          <p className="text-gray-600">Open source contributions and projects</p>
        </div>
        ...
        >
          ...
          <div className="relative bg-white rounded-xl p-8 border border-gray-200 hover:border-gray-300 transition">
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                <h3 className="text-2xl font-bold text-gray-900">umeshgupta05</h3>
            ...
            <p className="text-gray-700 mb-12">
              Full Stack Developer & AI Enthusiast. Building innovative projects with Python, React, and Machine Learning.
            </p>

            {/* Detailed Stats Grid */}
            <div className="mb-8">
              <h4 className="text-lg font-semibold text-gray-900 mb-6">GitHub Statistics</h4>
            ...
            <div className="grid md:grid-cols-3 gap-6 p-6 bg-gradient-to-r from-blue-50 to-cyan-50 rounded-lg border border-blue-200">
              ...
              >
                ...
                <p className="text-4xl font-bold text-blue-600">{githubData?.public_repos || 0}</p>
              </motion.div>
              <motion.div
                initial={{ opacity: 0, y: -20 }}
                whileInView={{ opacity: 1, y: 0 }}
              ...
              >
                ...
                <p className="text-4xl font-bold text-yellow-600">{githubData?.stars || 0}⭐</p>
              </motion.div>
              <motion.div
                initial={{ opacity: 0, x: 20 }}
                whileInView={{ opacity: 1, x: 0 }}
              ...
              >
                ...
                <p className="text-4xl font-bold text-purple-600">{githubData?.followers || 0}👥</p>
              </motion.div>
            </div>
        ...
        >
          ...
          >
            ...
            <div className="relative bg-white rounded-xl p-8 border border-gray-200 hover:border-gray-300 transition">
              <h3 className="text-xl font-bold text-gray-900 mb-6">Contribution Streak</h3>
              <div className="space-y-6">
                <div>
                  <p className="text-gray-600 text-sm mb-2">Current Streak</p>
                  <p className="text-4xl font-bold text-orange-600">{contributionStreak.current}</p>
                  <p className="text-gray-500 text-xs mt-1">days</p>
                </div>
                <div>
                  <p className="text-gray-600 text-sm mb-2">Longest Streak</p>
                  <p className="text-4xl font-bold text-red-600">{contributionStreak.longest}</p>
                  <p className="text-gray-500 text-xs mt-1">days</p>
                </div>
              </div>
            </div>
            ...
            <div className="relative bg-white rounded-xl p-8 border border-gray-200 hover:border-gray-300 transition">
              ...
              <div className="space-y-3">
                {recentContributions.map((contrib, index) => (
                  ...
                  >
                    <span className="text-gray-700 font-medium">{contrib.type}</span>
                    <span className="text-lg font-bold text-purple-600">{contrib.count}</span>
                  </motion.div>
                ))}
              </div>
            </div>
        ...
        {languages.length > 0 && (
          ...
          >
            ...
            <div className="relative bg-white rounded-xl p-8 border border-gray-200 hover:border-gray-300 transition">
              <h3 className="text-2xl font-bold text-gray-900 mb-8">Languages Used</h3>
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  {languages.map((lang, index) => (
                    ...
                    >
                      ...
                      <span className="text-sm font-semibold text-gray-700">{lang.percentage}%</span>
                    </motion.div>
                  ))}
                </div>
              </div>
